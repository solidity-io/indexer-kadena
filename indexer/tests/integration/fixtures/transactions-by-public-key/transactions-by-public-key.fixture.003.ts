export const transactionsByPublicKeyFixture003 = {
  data: {
    transactionsByPublicKey: {
      pageInfo: {
        endCursor: 'MTYyNDU1NTExNw==',
        hasNextPage: true,
        hasPreviousPage: true,
        startCursor: 'MTYzMDc2MDM5MA==',
      },
      edges: [
        {
          cursor: 'MTYzMDc2MDM5MA==',
          node: {
            cmd: {
              meta: {
                chainId: 2,
                creationTime: '2021-09-04T12:59:50.000Z',
                gasLimit: '3000',
                gasPrice: 1e-12,
              ...
              networkId: 'mainnet01',
              nonce: '2021-09-04T13:00:49.970Z',
              payload: {
                code: '"(kswap.exchange.add-liquidity\\n            coin\\n            runonflux.flux\\n            (read-decimal \'amountDesired0)\\n            (read-decimal \'amountDesired1)\\n            (read-decimal \'amountMinimum0)\\n            (read-decimal \'amountMinimum1)\\n            \\"1001e8d69988110ca08122cf6d4e0258cac3b3a3de1978c47080a1cf9f0bcadf\\"\\n            \\"1001e8d69988110ca08122cf6d4e0258cac3b3a3de1978c47080a1cf9f0bcadf\\"\\n            (read-keyset \'user-ks)\\n          )"',
                data: '{"user-ks":{"keys":["1001e8d69988110ca08122cf6d4e0258cac3b3a3de1978c47080a1cf9f0bcadf"],"pred":"keys-all"},"amountDesired0":15456.26547933,"amountDesired1":49969.32895717,"amountMinimum0":13137.8256574305,"amountMinimum1":42473.92961359}',
              },
              signers: [
                {
                  address: null,
                  clist: [
                    ...
                    {
                      args: '["1001e8d69988110ca08122cf6d4e0258cac3b3a3de1978c47080a1cf9f0bcadf","6SMAbH1iWh-6aOtnACqhiGk9BxbGzvYAyDmjwmLBKGc",15456.26547933]',
                      name: 'coin.TRANSFER',
                    },
                    {
                      args: '["1001e8d69988110ca08122cf6d4e0258cac3b3a3de1978c47080a1cf9f0bcadf","6SMAbH1iWh-6aOtnACqhiGk9BxbGzvYAyDmjwmLBKGc",49969.32895717]',
                      name: 'runonflux.flux.TRANSFER',
                    },
                  ],
                  id: 'U2lnbmVyOlsiV2t2M3hteVk1ZWktekFqVlBJRkI2bzdKb1RVc1hqWjdXNTFBRDZZTFl0dyIsIjAiXQ==',
                  orderIndex: 0,
            ...
            hash: 'Wkv3xmyY5ei-zAjVPIFB6o7JoTUsXjZ7W51AD6YLYtw',
            id: 'VHJhbnNhY3Rpb246WyJQNGxUajE4U2lYNFlMdDVOU0JnM1h0Z0duVk1kRWVUQXl3WmVKaEQ1SmpVIiwiV2t2M3hteVk1ZWktekFqVlBJRkI2bzdKb1RVc1hqWjdXNTFBRDZZTFl0dyJd',
            orphanedTransactions: null,
            result: {
              badResult: null,
              block: {
                id: 'QmxvY2s6UDRsVGoxOFNpWDRZTHQ1TlNCZzNYdGdHblZNZEVlVEF5d1plSmhENUpqVQ==',
              },
              continuation: null,
              eventCount: 5,
              events: {
                pageInfo: {
                  endCursor: 'MjE4ODU5OTU3',
                  hasNextPage: false,
                  hasPreviousPage: false,
                  startCursor: 'MjE4ODU5OTYx',
                },
                edges: [
                  {
                    node: {
                      id: 'RXZlbnQ6WyJQNGxUajE4U2lYNFlMdDVOU0JnM1h0Z0duVk1kRWVUQXl3WmVKaEQ1SmpVIiwiNCIsIldrdjN4bXlZNWVpLXpBalZQSUZCNm83Sm9UVXNYalo3VzUxQUQ2WUxZdHciXQ==',
                    },
                  },
                  {
                    node: {
                      id: 'RXZlbnQ6WyJQNGxUajE4U2lYNFlMdDVOU0JnM1h0Z0duVk1kRWVUQXl3WmVKaEQ1SmpVIiwiMyIsIldrdjN4bXlZNWVpLXpBalZQSUZCNm83Sm9UVXNYalo3VzUxQUQ2WUxZdHciXQ==',
                    },
                  },
                  {
                    node: {
                      id: 'RXZlbnQ6WyJQNGxUajE4U2lYNFlMdDVOU0JnM1h0Z0duVk1kRWVUQXl3WmVKaEQ1SmpVIiwiMiIsIldrdjN4bXlZNWVpLXpBalZQSUZCNm83Sm9UVXNYalo3VzUxQUQ2WUxZdHciXQ==',
                    },
                  },
                  {
                    node: {
                      id: 'RXZlbnQ6WyJQNGxUajE4U2lYNFlMdDVOU0JnM1h0Z0duVk1kRWVUQXl3WmVKaEQ1SmpVIiwiMSIsIldrdjN4bXlZNWVpLXpBalZQSUZCNm83Sm9UVXNYalo3VzUxQUQ2WUxZdHciXQ==',
                    },
                  },
                  {
                    node: {
                      id: 'RXZlbnQ6WyJQNGxUajE4U2lYNFlMdDVOU0JnM1h0Z0duVk1kRWVUQXl3WmVKaEQ1SmpVIiwiMCIsIldrdjN4bXlZNWVpLXpBalZQSUZCNm83Sm9UVXNYalo3VzUxQUQ2WUxZdHciXQ==',
                    },
                  },
                ],
              },
              gas: '2049',
              goodResult:
                '{"supply":{"decimal":"714003.461848156505"},"amount0":{"decimal":"15456.265479327179"},"amount1":49969.32895717,"liquidity":{"decimal":"27661.742930454683"}}',
              logs: '7l5HZRPsjEOblJbXdeloCJZVtcu1ObHGxUH16NTk54U',
              transactionId: '2041032',
              transfers: {
                edges: [
                  {
                    node: {
                      id: 'VHJhbnNmZXI6WyJQNGxUajE4U2lYNFlMdDVOU0JnM1h0Z0duVk1kRWVUQXl3WmVKaEQ1SmpVIiwiMiIsIjIiLCJYbFN3M1BFSVpnQ05LX2U4b0hpa2ZlMVVJQzFneVpuWVd0UHktT2QxOXVjIiwiV2t2M3hteVk1ZWktekFqVlBJRkI2bzdKb1RVc1hqWjdXNTFBRDZZTFl0dyJd',
                    },
                  },
                  {
                    node: {
                      id: 'VHJhbnNmZXI6WyJQNGxUajE4U2lYNFlMdDVOU0JnM1h0Z0duVk1kRWVUQXl3WmVKaEQ1SmpVIiwiMiIsIjEiLCIxb3Nfc0xBVVl2QnpzcG41amphd3RScEpXaUgxV1BmaHlOcmFlVnZTSXdVIiwiV2t2M3hteVk1ZWktekFqVlBJRkI2bzdKb1RVc1hqWjdXNTFBRDZZTFl0dyJd',
                    },
                  },
                  {
                    node: {
                      id: 'VHJhbnNmZXI6WyJQNGxUajE4U2lYNFlMdDVOU0JnM1h0Z0duVk1kRWVUQXl3WmVKaEQ1SmpVIiwiMiIsIjAiLCIxb3Nfc0xBVVl2QnpzcG41amphd3RScEpXaUgxV1BmaHlOcmFlVnZTSXdVIiwiV2t2M3hteVk1ZWktekFqVlBJRkI2bzdKb1RVc1hqWjdXNTFBRDZZTFl0dyJd',
                    },
                  },
                ],
              },
            ...
            sigs: [
              {
                sig: 'b6dd10d0dd1450d018e4f884e35ef49dc43e9125963b9dfb622f4b7d263e22fb75960df787aadc2891d7810c213c80a0757318d83dbe0d241c9c1add86891b02',
              },
            ],
          },
        },
